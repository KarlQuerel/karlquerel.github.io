 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function _t(t){return t&&t._delegate?t._delegate:t}class Tt{constructor(t,e,n){this.name=t,this.instanceFactory=e,this.type=n,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(t){return this.instantiationMode=t,this}setMultipleInstances(t){return this.multipleInstances=t,this}setServiceProps(t){return this.serviceProps=t,this}setInstanceCreatedCallback(t){return this.onInstanceCreated=t,this}}
/**
 * @license
 ...
 * limitations under the License.
 */
class Yt{constructor(t){this.container=t}getPlatformInfoString(){return this.container.getProviders().map(t=>{if(function(t){const e=t.getComponent();return"VERSION"===(null==e?void 0:e.type)}(t)){const e=t.getImmediate();return`${e.library}/${e.version}`}return null}).filter(t=>t).join(" ")}}const Xt="@firebase/app",Jt="0.11.5",Zt=new Lt("@firebase/app"),te="@firebase/app-compat",ee="@firebase/analytics-compat",ne="@firebase/analytics",re="@firebase/app-check-compat",se="@firebase/app-check",ie="@firebase/auth",oe="@firebase/auth-compat",ae="@firebase/database",ce="@firebase/data-connect",ue="@firebase/database-compat",le="@firebase/functions",he="@firebase/functions-compat",de="@firebase/installations",fe="@firebase/installations-compat",pe="@firebase/messaging",me="@firebase/messaging-compat",ge="@firebase/performance",ye="@firebase/performance-compat",ve="@firebase/remote-config",we="@firebase/remote-config-compat",Ee="@firebase/storage",be="@firebase/storage-compat",_e="@firebase/firestore",Te="@firebase/vertexai",Se="@firebase/firestore-compat",Ie="firebase",Ce="[DEFAULT]",Ae={[Xt]:"fire-core",[te]:"fire-core-compat",[ne]:"fire-analytics",[ee]:"fire-analytics-compat",[se]:"fire-app-check",[re]:"fire-app-check-compat",[ie]:"fire-auth",[oe]:"fire-auth-compat",[ae]:"fire-rtdb",[ce]:"fire-data-connect",[ue]:"fire-rtdb-compat",[le]:"fire-fn",[he]:"fire-fn-compat",[de]:"fire-iid",[fe]:"fire-iid-compat",[pe]:"fire-fcm",[me]:"fire-fcm-compat",[ge]:"fire-perf",[ye]:"fire-perf-compat",[ve]:"fire-rc",[we]:"fire-rc-compat",[Ee]:"fire-gcs",[be]:"fire-gcs-compat",[_e]:"fire-fst",[Se]:"fire-fst-compat",[Te]:"fire-vertex","fire-js":"fire-js",[Ie]:"fire-js-all"},De=new Map,ke=new Map,Ne=new Map;function xe(t,e){try{t.container.addComponent(e)}catch(n){Zt.debug(`Component ${e.name} failed to register with FirebaseApp ${t.name}`,n)}}function Re(t){const e=t.name;if(Ne.has(e))return Zt.debug(`There were multiple attempts to register component ${e}.`),!1;Ne.set(e,t);for(const n of De.values())xe(n,t);for(const n of ke.values())xe(n,t);return!0}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Me(t,e={}){let n=t;if("object"!=typeof e){e={name:e}}const r=Object.assign({name:Ce,automaticDataCollectionEnabled:!1},e),s=r.name;if("string"!=typeof s||!s)throw Le.create("bad-app-name",{appName:String(s)});if(n||(n=pt()),!n)throw Le.create("no-options");const i=De.get(s);if(i){if(Et(n,i.options)&&Et(r,i.config))return i;throw Le.create("duplicate-app",{appName:s})}const o=new Ct(s);for(const c of Ne.values())o.addComponent(c);const a=new Oe(n,r,o);return De.set(s,a),a}function Pe(t,e,n){var r;let s=null!==(r=Ae[t])&&void 0!==r?r:t;n&&(s+=`-${n}`);const i=s.match(/\s|\//),o=e.match(/\s|\//);if(i||o){const t=[`Unable to register library "${s}" with version "${e}":`];return i&&t.push(`library name "${s}" contains illegal characters (whitespace or "/")`),i&&o&&t.push("and"),o&&t.push(`version name "${e}" contains illegal characters (whitespace or "/")`),void Zt.warn(t.join(" "))}Re(new Tt(`${s}-version`,()=>({library:s,version:e}),"VERSION"))}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ve="firebase-heartbeat-store";let Fe=null;function Ue(){return Fe||(Fe=function(t,e,{blocked:n,upgrade:r,blocking:s,terminated:i}={}){const o=indexedDB.open(t,e),a=qt(o);return r&&o.addEventListener("upgradeneeded",t=>{r(qt(o.result),t.oldVersion,t.newVersion,qt(o.transaction),t)}),n&&o.addEventListener("blocked",t=>n(t.oldVersion,t.newVersion,t)),a.then(t=>{i&&t.addEventListener("close",()=>i()),s&&t.addEventListener("versionchange",t=>s(t.oldVersion,t.newVersion,t))}).catch(()=>{}),a}("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)try{t.createObjectStore(Ve)}catch(n){}}}).catch(t=>{throw Le.create("idb-open",{originalErrorMessage:t.message})})),Fe}async function Be(t,e){try{const n=(await Ue()).transaction(Ve,"readwrite"),r=n.objectStore(Ve);await r.put(e,je(t)),await n.done}catch(n){if(n instanceof yt)Zt.warn(n.message);else{const t=Le.create("idb-set",{originalErrorMessage:null==n?void 0:n.message});Zt.warn(t.message)}}}function je(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function xn(t){const e="undefined"!=typeof self&&(self.crypto||self.msCrypto),n=new Uint8Array(t);if(e&&"function"==typeof e.getRandomValues)e.getRandomValues(n);else for(let r=0;r<t;r++)n[r]=Math.floor(256*Math.random());return n}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ln{static newId(){const t=62*Math.floor(256/62);let e="";for(;e.length<20;){const n=xn(40);for(let r=0;r<n.length;++r)e.length<20&&n[r]<t&&(e+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789".charAt(n[r]%62))}return e}}function On(t,e){return t<e?-1:t>e?1:0}function Mn(t,e){let n=0;for(;n<t.length&&n<e.length;){const r=t.codePointAt(n),s=e.codePointAt(n);if(r!==s){if(r<128&&s<128)return On(r,s);{const i=Rn(),o=Vn(i.encode(Pn(t,n)),i.encode(Pn(e,n)));return 0!==o?o:On(r,s)}}n+=r>65535?2:1}return On(t.length,e.length)}function Pn(t,e){return t.codePointAt(e)>65535?t.substring(e,e+2):t.substring(e,e+1)}function Vn(t,e){for(let n=0;n<t.length&&n<e.length;++n)if(t[n]!==e[n])return On(t[n],e[n]);return On(t.length,e.length)}function Fn(t,e,n){return t.length===e.length&&t.every((t,r)=>n(t,e[r]))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _r="server_timestamp",Tr="__type__",Sr="__previous_value__",Ir="__local_write_time__";function Cr(t){var e,n;return(null===(n=((null===(e=null==t?void 0:t.mapValue)||void 0===e?void 0:e.fields)||{})[Tr])||void 0===n?void 0:n.stringValue)===_r}function Ar(t){const e=t.mapValue.fields[Sr];return Cr(e)?Ar(e):e}function Dr(t){const e=wr(t.mapValue.fields[Ir].timestampValue);return new jn(e.seconds,e.nanos)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class kr{constructor(t,e,n,r,s,i,o,a,c){this.databaseId=t,this.appId=e,this.persistenceKey=n,this.host=r,this.ssl=s,this.forceLongPolling=i,this.autoDetectLongPolling=o,this.longPollingOptions=a,this.useFetchStreams=c}}const Nr="(default)";class xr{constructor(t,e){this.projectId=t,this.database=e||Nr}static empty(){return new xr("","")}get isDefaultDatabase(){return this.database===Nr}isEqual(t){return t instanceof xr&&t.projectId===this.projectId&&t.database===this.database}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Rr="__type__",Lr="__max__",Or={},Mr="__vector__",Pr="value";function Vr(t){return"nullValue"in t?0:"booleanValue"in t?1:"integerValue"in t||"doubleValue"in t?2:"timestampValue"in t?3:"stringValue"in t?5:"bytesValue"in t?6:"referenceValue"in t?7:"geoPointValue"in t?8:"arrayValue"in t?9:"mapValue"in t?Cr(t)?4:function(t){return(((t.mapValue||{}).fields||{}).__type__||{}).stringValue===Lr}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var Oi,Mi;function Pi(t){if(void 0===t)return fn("GRPC error has no .code"),En.UNKNOWN;switch(t){case Oi.OK:return En.OK;case Oi.CANCELLED:return En.CANCELLED;case Oi.UNKNOWN:return En.UNKNOWN;case Oi.DEADLINE_EXCEEDED:return En.DEADLINE_EXCEEDED;case Oi.RESOURCE_EXHAUSTED:return En.RESOURCE_EXHAUSTED;case Oi.INTERNAL:return En.INTERNAL;case Oi.UNAVAILABLE:return En.UNAVAILABLE;case Oi.UNAUTHENTICATED:return En.UNAUTHENTICATED;case Oi.INVALID_ARGUMENT:return En.INVALID_ARGUMENT;case Oi.NOT_FOUND:return En.NOT_FOUND;case Oi.ALREADY_EXISTS:return En.ALREADY_EXISTS;case Oi.PERMISSION_DENIED:return En.PERMISSION_DENIED;case Oi.FAILED_PRECONDITION:return En.FAILED_PRECONDITION;case Oi.ABORTED:return En.ABORTED;case Oi.OUT_OF_RANGE:return En.OUT_OF_RANGE;case Oi.UNIMPLEMENTED:return En.UNIMPLEMENTED;case Oi.DATA_LOSS:return En.DATA_LOSS;default:return gn(39323,{code:t})}}(Mi=Oi||(Oi={}))[Mi.OK=0]="OK",Mi[Mi.CANCELLED=1]="CANCELLED",Mi[Mi.UNKNOWN=2]="UNKNOWN",Mi[Mi.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",Mi[Mi.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",Mi[Mi.NOT_FOUND=5]="NOT_FOUND",Mi[Mi.ALREADY_EXISTS=6]="ALREADY_EXISTS",Mi[Mi.PERMISSION_DENIED=7]="PERMISSION_DENIED",Mi[Mi.UNAUTHENTICATED=16]="UNAUTHENTICATED",Mi[Mi.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",Mi[Mi.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",Mi[Mi.ABORTED=10]="ABORTED",Mi[Mi.OUT_OF_RANGE=11]="OUT_OF_RANGE",Mi[Mi.UNIMPLEMENTED=12]="UNIMPLEMENTED",Mi[Mi.INTERNAL=13]="INTERNAL",Mi[Mi.UNAVAILABLE=14]="UNAVAILABLE",Mi[Mi.DATA_LOSS=15]="DATA_LOSS";
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class $i{constructor(t,e,n,r,s){this.snapshotVersion=t,this.targetChanges=e,this.targetMismatches=n,this.documentUpdates=r,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(t,e,n){const r=new Map;return r.set(t,zi.createSynthesizedTargetChangeForCurrentChange(t,e,n)),new $i($n.min(),r,new lr(On),js(),Ys())}}class zi{constructor(t,e,n,r,s){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(t,e,n){return new zi(n,e,Ys(),Ys(),Ys())}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class ko{constructor(t){this.wt=t}}function No(t){const e=vo({parent:t.parent,structuredQuery:t.structuredQuery});return"LAST"===t.limitType?Rs(e,e.limit,"L"):e}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Mo.DEFAULT_COLLECTION_PERCENTILE=10,Mo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,Mo.DEFAULT=new Mo(Oo,Mo.DEFAULT_COLLECTION_PERCENTILE,Mo.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),Mo.DISABLED=new Mo(-1,0,0);
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}const _a="RestConnection",Ta={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery"};class Sa{get Bo(){return!1}constructor(t){this.databaseInfo=t,this.databaseId=t.databaseId;const e=t.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Lo=e+"://"+t.host,this.ko=`projects/${n}/databases/${r}`,this.qo=this.databaseId.database===Nr?`project_id=${n}`:`project_id=${n}&database_id=${r}`}Qo(t,e,n,r,s){const i=ba(),o=this.$o(t,e.toUriEncodedString());dn(_a,`Sending RPC '${t}' ${i}:`,o,n);const a={"google-cloud-resource-prefix":this.ko,"x-goog-request-params":this.qo};return this.Uo(a,r,s),this.Ko(t,o,a,n).then(e=>(dn(_a,`Received RPC '${t}' ${i}: `,e),e),e=>{throw pn(_a,`RPC '${t}' ${i} failed with error: `,e,"url: ",o,"request:",n),e})}Wo(t,e,n,r,s,i){return this.Qo(t,e,n,r,s)}Uo(t,e,n){t["X-Goog-Api-Client"]="gl-js/ fire/"+un,t["Content-Type"]="text/plain",this.databaseInfo.appId&&(t["X-Firebase-GMPID"]=this.databaseInfo.appId),e&&e.headers.forEach((e,n)=>t[n]=e),n&&n.headers.forEach((e,n)=>t[n]=e)}$o(t,e){const n=Ta[t];return`${this.Lo}/v1/${e}:${n}`}terminate(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(r.mockUserToken,null===(s=t._app)||void 0===s?void 0:s.options.projectId);const i=r.mockUserToken.sub||r.mockUserToken.user_id;if(!i)throw new bn(En.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new cn(i)}t._authCredentials=new In(new Tn(e,n))}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t),t._firestoreClient}class Lu{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Lu(yr.fromBase64String(t))}catch(e){throw new bn(En.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+e)}}static fromUint8Array(t){return new Lu(yr.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ou{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new bn(En.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new Hn(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Pu{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new bn(En.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new bn(En.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return On(this._lat,t._lat)||On(this._long,t._long)}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ll(t){t=vu(t,Iu);const e=vu(t.firestore,xu);return fu(Ru(e),t._key).then(n=>function(t,e,n){const r=n.docs.get(e._key),s=new hl(t);return new cl(t,s,e._key,r,new al(n.hasPendingWrites,n.fromCache),e.converter)}(e,t,n))}class hl extends ol{constructor(t){super(),this.firestore=t}convertBytes(t){return new Lu(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Iu(this.firestore,null,e)}}function dl(t,e,n){t=vu(t,Iu);const r=vu(t.firestore,xu),s=function(t,e){let n;return n=t?t.toFirestore(e):e,n}(t.converter,e);return pl(r,[Ku(qu(r),"setDoc",t._key,s,null!==t.converter,n).toMutation(t._key,mi.none())])}function fl(t,e,n,...r){t=vu(t,Iu);const s=vu(t.firestore,xu),i=qu(s);let o;return o="string"==typeof(e=_t(e))||e instanceof Ou?function(t,e,n,r,s,i){const o=t.dc(1,e,n),a=[Ju(e,r,n)],c=[s];if(i.length%2!=0)throw new bn(En.INVALID_ARGUMENT,`Function ${e}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let d=0;d<i.length;d+=2)a.push(Ju(e,i[d])),c.push(i[d+1]);const u=[],l=Jr.empty();for(let d=a.length-1;d>=0;--d)if(!nl(u,a[d])){const t=a[d];let e=c[d];e=_t(e);const n=o.hc(t);if(e instanceof Gu)u.push(t);else{const r=Qu(e,n);null!=r&&(u.push(t),l.set(t,r))}}const h=new mr(u);return new Bu(l,h,o.fieldTransforms)}(i,"updateDoc",t._key,e,n,r):function(t,e,n,r){const s=t.dc(1,e,n);Xu("Data must be an object, but it was:",s,r);const i=[],o=Jr.empty();cr(r,(t,r)=>{const a=tl(e,t,n);r=_t(r);const c=s.hc(a);if(r instanceof Gu)i.push(a);else{const t=Qu(r,c);null!=t&&(i.push(a),o.set(a,t))}});const a=new mr(i);return new Bu(o,a,s.fieldTransforms)}(i,"updateDoc",t._key,e),pl(s,[o.toMutation(t._key,mi.exists(!0))])}function pl(t,e){return function(t,e){const n=new _n;return t.asyncQueue.enqueueAndForget(async()=>Bc(await function(t){return hu(t).then(t=>t.syncEngine)}(t),e,n)),n.promise}(Ru(t),e)}function ml(t){return new Hu("increment",t)}!function(t,e=!0){un="11.6.1",Re(new Tt("firestore",(t,{instanceIdentifier:n,options:r})=>{const s=t.getProvider("app").getImmediate(),i=new xu(new Cn(t.getProvider("auth-internal")),new Nn(s,t.getProvider("app-check-internal")),function(t,e){if(!Object.prototype.hasOwnProperty.apply(t.options,["projectId"]))throw new bn(En.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new xr(t.options.projectId,e)}(s,n),s);return r=Object.assign({useFetchStreams:e},r),i._setSettings(r),i},"PUBLIC").setMultipleInstances(!0)),Pe(on,an,t),Pe(on,an,"esm2017")}();const gl=function(t){const e="object"==typeof t?t:function(t=Ce){const e=De.get(t);if(!e&&t===Ce&&pt())return Me();if(!e)throw Le.create("no-app",{appName:t});return e}(),n="string"==typeof t?t:Nr,r=function(t,e){const n=t.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),t.container.getProvider(e)}(e,"firestore").getImmediate({identifier:n});if(!r._initialized){const t=ft("firestore");t&&Tu(r,...t)}return r}(Me({apiKey:"AIzaSyCWhnqOzsDExtNu14s_gxUpAWeV-PPPog8",authDomain:"click-counter-4f529.firebaseapp.com",projectId:"click-counter-4f529",storageBucket:"click-counter-4f529.appspot.com",messagingSenderId:"950861743362",appId:"1:950861743362:web:77dc41eb31b34334566e1b",measurementId:"G-7EEMWQS33Z"})),yl=Au(gl,"clicks","counter"),vl=Au(gl,"terminal","stats");async function wl(){try{(await ll(vl)).exists()?await fl(vl,{totalVisits:ml(1),lastVisit:(new Date).toISOString()}):await dl(vl,{totalVisits:1,totalCommands:0,commandStats:{},lastVisit:(new Date).toISOString()})}catch(t){}}async function El(t){try{const e=await ll(vl);if(e.exists()){const n=e.data().commandStats||{};n[t]=(n[t]||0)+1,await fl(vl,{totalCommands:ml(1),commandStats:n})}else await dl(vl,{totalVisits:0,totalCommands:1,commandStats:{[t]:1},lastVisit:(new Date).toISOString()})}catch(e){}}async function bl(){try{const t=await ll(vl);if(t.exists()){const e=t.data();return{totalVisits:e.totalVisits||0,totalCommands:e.totalCommands||0,commandStats:e.commandStats||{},lastVisit:e.lastVisit?new Date(e.lastVisit):null}}return{totalVisits:0,totalCommands:0,commandStats:{},lastVisit:null}}catch(t){return{totalVisits:0,totalCommands:0,commandStats:{},lastVisit:null}}}const _l={key:0},Tl={key:1},Sl={class:"nes-container is-dark with-title is-centered is-rounded"},Il=S({__name:"clickCounter",setup(t){const n=u(null),i=u(!0);async function o(){n.value++;try{await async function(){await fl(yl,{count:ml(1)})}()}catch{n.value--}}return e(async()=>{try{n.value=await async function(){const t=await ll(yl);return t.exists()?t.data().count:0}()}catch{n.value=0}finally{i.value=!1}}),(t,e)=>(r(),s("div",null,[i.value?(r(),s("p",_l,"Loading...")):(r(),s("div",Tl,[h("div",Sl,[e[0]||(e[0]=h("p",{class:"title"},"Waste your time",-1)),h("button",{id:"clicker",class:"nes-btn is-normal",onClick:o}," ONE CLICK AT A TIME "),h("p",null,[h("span",null,E(n.value),1)])])]))]))}},[["__scopeId","data-v-cd422135"]]),Cl={class:"content"},Al=[{path:"/",component:()=>C(()=>import("./HeroIntro-FGDyZtZY.js"),__vite__mapDeps([0,1,2,3,4,5]))},{path:"/terminal",component:()=>C(()=>import("./terminal-DMz5Px7c.js"),__vite__mapDeps([6,1,2,3,7,5]))},{path:"/about",component:()=>C(()=>import("./About-DOez-jce.js"),__vite__mapDeps([8,1,2,3,9,5]))},{path:"/under_construction",component:S({__name:"underConstruction",setup:t=>(t,e)=>(r(),s("div",Cl,[e[0]||(e[0]=h("div",{class:"nes-container is-dark is-rounded"},[h("p",null,"Under Construction"),h("img",{src:"/assets/img/construction.gif",alt:"construction GIF",class:"construction-gif"})],-1)),f(Il)]))},[["__scopeId","data-v-011c88b3"]])},{path:"/secret_link",component:nt},{path:"/game",component:()=>C(()=>import("./game-Cre5MPO8.js").then(t=>t.G),__vite__mapDeps([2,1,3]))},{path:"/contact",component:()=>C(()=>import("./Contact-DcLqpsPd.js"),__vite__mapDeps([10,2,1,3,11]))},{path:"/sport",component:()=>C(()=>import("./sport-C74TvCxl.js"),__vite__mapDeps([12,1]))},{path:"/:pathMatch(.*)*",component:st}],Dl=b({history:_("/"),routes:Al});T(et).use(Dl).mount("#app");export{wl as a,bl as l,A as p,El as t,D as u};
