...
export const CAMERA_PORTRAIT = {
	...
	// The narrow frame parks the world under the stations' copy, so it recedes while they are read.
	work: { x: -55, y: -6, scale: 1.6, fade: 0.5, roll: 0.22, tilt: -2, light: 0.1 },
	workEnd: { x: -53, y: -11, scale: 1.72, fade: 0.5, roll: 0.26, tilt: -1, light: 0.1 },
	dive: { x: 4, y: 46, scale: 4.4, fade: 1, roll: 0.62, tilt: 5, light: 0.1 },
	skim: { x: 8, y: 45, scale: 4.45, fade: 1, roll: 0.86, tilt: 4, light: 0.1 },
	life: { x: 55, y: 0, scale: 2.0, fade: 0.5, roll: 0.94, tilt: 2, light: 0.1 },
	lifeEnd: { x: 52, y: -3, scale: 2.12, fade: 0.5, roll: 0.98, tilt: 1, light: 0.1 },
